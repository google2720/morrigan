...
public class WheelView extends View {
    ...
    // 条目间距倍数
    private static final float lineSpacingMultiplier = 2.75f;
    boolean isLoop;
    ...
    private void measureTextWidthHeight() {
        Rect rect = new Rect();
        int len = Math.min(1, adapter.getItemsCount());
        for (int i = 0; i < len; i++) {
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity) {
            ...
            case Gravity.RIGHT:
                ...
                drawCenterContentStart = Math.max(0, drawCenterContentStart - 10);
                break;
        }
    }
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (mGravity) {
            ...
            case Gravity.RIGHT:
                ...
                drawOutContentStart = Math.max(0, drawOutContentStart - 10);
                break;
        }
    }
